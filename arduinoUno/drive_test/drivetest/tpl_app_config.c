 ...
 * Automatically generated by goil on Fri Mar 19 07:16:23 2021
 * from root OIL file drivetest.oil
 *
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm navigationAl : stdAppmode */ 
};
...
/* Alarm navigationAl identifier */
#define navigationAl_id 0
CONST(AlarmType, AUTOMATIC) navigationAl = navigationAl_id;
...
#include "tpl_memmap.h"
tpl_stack_word navigation_stack_zone[256/sizeof(tpl_stack_word)];
...
#define navigation_STACK { navigation_stack_zone, 256 }

/*
 * Task navigation context
 */
avr_context navigation_int_context;
...
CONST(tpl_task_activation_action, OS_CONST) navigationAl_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) navigationAl_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , navigationAl_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&navigationAl_action
};
...
VAR(tpl_time_obj, OS_VAR) navigationAl_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&navigationAl_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  200,
    /* date                         */  200,
