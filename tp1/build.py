...
cSourceList.append(projfile.ProjectFile("tp1.c"))
cSourceList.append(projfile.ProjectFile("../ecrobot_emul.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("tp1/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("tp1/tpl_os.c"))
