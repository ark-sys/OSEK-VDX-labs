...
CONST(tpl_appmode_mask, OS_CONST) tpl_task_app_mode[TASK_COUNT] = {
  0 /* task stop :  */ ,
  0 /* task detection_distance :  */ ,
  0 /* task navigation :  */ ,
  0 /* task detection_contact :  */ 
};
...
#include "tpl_memmap.h"
tpl_stack_word detection_distance_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_detection_distance_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK detection_distance_stack = {detection_distance_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define detection_distance_STACK &detection_distance_stack
...
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT detection_distance_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define detection_distance_CONTEXT &detection_distance_context
...
#include "tpl_memmap.h"
tpl_stack_word detection_contact_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_detection_contact_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK detection_contact_stack = {detection_contact_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define detection_contact_STACK &detection_contact_stack
...
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT detection_contact_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define detection_contact_CONTEXT &detection_contact_context
