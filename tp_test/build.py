...
#--- OIL file
oilSourceList.append("tp_test.oil")
...
cSourceList.append(projfile.ProjectFile("tp_test.c"))
cSourceList.append(projfile.ProjectFile("../ecrobot_emul.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("tp_test/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("tp_test/tpl_os.c"))
