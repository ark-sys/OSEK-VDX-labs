...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file tp_test.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=posix/linux --templates=../../../goil/templates/ tp_test.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("tp_test/tpl_app_config.c")

sourceList.append("tp_test/tpl_os.c")
